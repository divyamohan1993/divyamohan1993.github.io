! function(t) {
	...
	function m(t) {
		for (var e, n = document.getElementById(t), i = n.innerHTML.replace("&amp;", "&")
				.split(""), a = "", o = 0, s = i.length; s > o; o++) e = i[o].replace("&", "&amp"), a += e.trim() ? '<span class="letter-' + o + '">' + e + "</span>" : "&nbsp;";
	...
	var f, l, v, g, y, x = {},
		w = [],
		E = {};
	E.debug = !1, E.friction = .5, E.trails = 20, E.size = 50, E.dampening = .25, E.tension = .99, Math.TWO_PI = 2 * Math.PI, e.prototype = function() {
		var t = 0;
		return {
			init: function(t) {
		...
		if (f = document.getElementById("canvas")
			.getContext("2d"), f.stats = new Stats, f.running = !0, f.frame = 1, v = new Image, v.src = "C:/Users/DIVYA/Documents/GitHub/divyamohan1993.github.io/media/images/development/lightandmotion/no-logo.png", l = new e({
			...
			var n = new dat.GUI;
			n.add(E, "trails", 1, 30)
				.onChange(a), n.add(E, "size", 25, 75)
				.onFinishChange(a), n.add(E, "friction", .45, .55)
				.onFinishChange(a), n.add(E, "dampening", .01, .4)
				.onFinishChange(a), n.add(E, "tension", .95, .999)
				.onFinishChange(a), document.body.appendChild(f.stats.domElement)
		}
	}
}(window);
