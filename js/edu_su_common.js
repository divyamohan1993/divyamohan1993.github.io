...
(function () {
    // Dynamically include var.js - Works ONLY FOR INDEX.HTML
    // if you use it on other files then it creates the name of file as folder before var.js
    // Manually include in such files. 
