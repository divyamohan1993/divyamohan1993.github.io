    ...
    class Evision_Customizer{
        ...
        public function setting_control_default_values( $settings_control_id, $setting_control ) {
            ...
            elseif( 'textarea_sc' == $setting_control_type ){
                $evision_customizer_default_sanitize_callback = 'wp_kses_post';
                $setting_control['control']['type'] = 'textarea';
            }
            elseif( 'textarea_css' == $setting_control_type ){
                $evision_customizer_default_sanitize_callback = 'wp_sportfolio_all_tags';
                $setting_control['control']['type'] = 'textarea';
            }
        ...
        function add_scripts_styles(){
            ...
            if ( 'customize.php' == $pagenow ) {
                wp_enqueue_style( 'evision-customizer-style', get_template_directory_uri() . '/inc/frameworks/evision-customizer/assets/css/evision-customizer.css', false, EVISION_CUSTOMIZER_VERSION );
            }
        }
