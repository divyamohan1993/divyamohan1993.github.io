...
<html lang="en">
	...
	<head>
		...
		<link rel="stylesheet preconnect" href="/stylesheets/meny/meny.css">
		<link rel='publisher preconnect' href='//plus.google.com/+DivyaMohan1993'>
				
		<script src="//cdnjs.cloudflare.com/ajax/libs/jquery/3.0.0-beta1/jquery.min.js"></script>
		
		<script src="/javascripts/force_https/https.js"></script>
...
})(window,document,'script','dataLayer','GTM-PQ4VPSD');</script>
<!-- End Google Tag Manager -->
	...
	<body>
		...
		<!-- Google Tag Manager (noscript) --><noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PQ4VPSD" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript><!-- End Google Tag Manager (noscript) -->
		<div id="google_translate_element"></div>
		<script type="text/javascript">function googleTranslateElementInit() { new google.translate.TranslateElement({pageLanguage: 'en', layout: google.translate.TranslateElement.FloatPosition.TOP_LEFT, gaTrack: true, gaId: 'UA-26013850-2'}, 'google_translate_element'); }</script>
