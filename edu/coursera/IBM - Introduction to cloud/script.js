! function (t) {
    ...
    E.debug = !1, E.friction = .5, E.trails = 20, E.size = 50, E.dampening = .25, E.tension = .98, Math.TWO_PI = 2 * Math.PI, e.prototype = function () {
        ...
        if (f = document.getElementById("canvas")
            .getContext("2d"), f.running = !0, f.frame = 1, l = new e({
                phase: Math.random() * Math.TWO_PI,
                amplitude: 95,
                frequency: .0015,
                offset: 285
            }), document.addEventListener("mousemove", i), document.addEventListener("touchstart", i), document.body.addEventListener("orientationchange", s), t.addEventListener("resize", s), t.addEventListener("keyup", c), t.addEventListener("focus", r), t.addEventListener("blur", h), s(), t.DEBUG) {
            var n = new dat.GUI;
            n.add(E, "trails", 1, 30)
